...
setup(
    ...
    url="https://github.com/PyTorchKorea/lightning_sphinx_theme",
    docs_url="https://github.com/PyTorchKorea/lightning_sphinx_theme",
    description="PyTorch Lightning Sphinx Theme",
